...
<template>
  ...
  <APageContainer class="a-man-add-to-chat">
    <span>
      ...
      только владелец чата сможет добавить бота.
    </span>
    <AButton
      class="self-start"
      icon="Icon24Picture"
    ...
    <span>
      ...
      команду «!задатьВладельца», чтобы получить полные права. Если до Вас
      кто-то написал эту команду и забрал владельца себе — исключите его из чата
